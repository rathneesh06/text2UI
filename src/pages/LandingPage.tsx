...
export default function LandingPage({ onStartBuild, onFiles, onRemoveSource, tables, fileError, coloAvailable, coloSelected, onUseColo, onClearColo }: LandingPageProps) {
  const hasData = tables.length > 0;
  const canSubmit = hasData || !!coloSelected || !!coloAvailable;
